...
from app import users, schools, students, teachers, strengthes, weaknesses, destinations, goals, documents, models


doc = Blueprint('documents', __name__, template_folder='templates')
