...
class User(db.Model):
    ...
    school_logo_name = db.Column(db.String(200))  # FOR LAYOUT
    matya_logo_name =  db.Column(db.String(200))  # FOR LAYOUT
...
class General_txt(db.Model):
   ...
   # Anthonies suggestion
    ...
    students = db.relationship("Std_general_txt", back_populates="general_txt", 
                                                  cascade="all, delete")
...
class Student(db.Model):
    ...
    general_txts = db.relationship("Std_general_txt", back_populates="student", 
