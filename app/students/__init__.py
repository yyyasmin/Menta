...
from app import users, schools, students, teachers, strengthes, weaknesses, models, tags, age_category


std = Blueprint('students', __name__, template_folder='templates')
