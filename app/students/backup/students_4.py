...
def index():
    ...
    for u in users:
        ...
        print("USER Is  SUPE: ", u.is_super_user)
        print("USER Is GET SUPE: ", u.get_is_super_user())
    ### DEBUG ONLY
...
@std.route('/tag_to_profile_add/<int:tag_id>', methods=['GET', 'POST'])
def tag_to_profile_add(tag_id):
    ...
    sub_tag.set_parent(newDummyStrn)
    
    newDummyStrn.set_parent(tag)
    newDummyStrn.set_parent(sub_tag)
