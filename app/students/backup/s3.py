...
@std.route('/goal_to_destination_of_student_add', methods=['GET', 'POST'])
def goal_to_destination_of_student_add():
	...
	if request.method == 'GET':
		return render_template('students.edit_students_destinations_goals.html', student=student, destination=destination)
	...
	return render_template('edit_students_destinations_goals.html', student=student, destination=destnation)
  

@std.route('/goal_to_destination_of_student_add2/<int:selected_student_id>/<int:selected_destination_id>/<int:selected_goal_id>', methods=['GET', 'POST'])
def goal_to_destination_of_student_add2(selected_student_id, selected_destination_id):
	print(selected_student_id)
	std = student_select2(selected_student_id)
	dst = student_select2(selected_destination_id)
	goal = student_select2(selected_goal_id)
