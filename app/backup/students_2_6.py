...
from .teachers import teacher_select2

from .models import User, Student, Teacher, Profile, Strength, Weaknesse, Role
...
@app.route('/teachers_by_student_show')
@login_required
...
@app.route('/teachers_by_student_show2/<int:selected_student_id>', methods=['GET', 'POST'])
...
@app.route('/edit_student_teachers', methods=['GET', 'POST'])
...
@app.route('/edit_student_teachers2/edit/<int:selected_student_id>/<int:selected_teacher_id>', methods=['GET', 'POST'])
...
@app.route('/teacher_to_student_add', methods=['GET', 'POST'])
...
@app.route('/teacher_to_student_add2/add/<int:selected_student_id>/<int:selected_teacher_id>', methods=['GET', 'POST'])
def teacher_to_student_add2(selected_student_id, selected_teacher_id):
	print("IIIIIIIIIIIIIIIn teacher_to_student_add222 view")
...
@app.route('/student_from_teacher_delete', methods=['GET', 'POST'])
...
@app.route('/student_from_teacher_delete2/add/<int:selected_teacher_id>/<int:selected_student_id>', methods=['GET', 'POST'])
...
@app.route('/get_student_teachers', methods=['GET', 'POST'])
...
@app.route('/get_teachers_not_of_student', methods=['GET', 'POST'])
...
@app.route('/student/unhide/<int:selected_student_id>', methods=['GET', 'POST'])
#Here author is user_id
