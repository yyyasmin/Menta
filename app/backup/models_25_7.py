...
class Role(db.Model):
	...
	def __init__(self, student_id, team_member_id, title):
		self.title=title
...
#FROM https://stackoverflow.com/questions/26470637/many-to-many-relationship-with-extra-fields-using-wtforms-sqlalchemy-and-flask	
    ...
    def teachers_list(self):
        return [chan_rel.to_dict() for chan_rel in self.teachers]


event.listen(Student, 'before_insert', Student.update_timestamp, retval=False)
event.listen(Student, 'before_update', Student.update_timestamp, retval=False)
#FROM https://stackoverflow.com/questions/26470637/many-to-many-relationship-with-extra-fields-using-wtforms-sqlalchemy-and-flask	
