...
def show_dst_tree():
    ...
    return render_template('./tree/root_tree.html',  
                                            dest=dst, dst=dst,
                                            dst_goals=dst_goals,
                                            dst_todos=dst_todos,
...
def dsply_dst_form_for_update(from_dst_sort_order):
    ...
    for sub_tag in all_sub_tags:
        if sub_tag.default == True and dst_tag.is_parent_of(sub_tag):
            dst_sub_tag = sub_tag
