...
from app.models import Tag, Destination, Goal, Due_date, Age_range, Scrt
...
@age.route('/edit_scrts', methods=['GET', 'POST'])
@login_required
def edit_scrts():
...
@age.route('/scrt_add', methods=['GET', 'POST'])
def scrt_add():
...
@age.route('/scrt_update/<int:selected_scrt_id>', methods=['GET', 'POST'])
...
@age.route('/scrt_delete_for_good', methods=['GET', 'POST'])
...
#from https://teamtreehouse.com/community/add-a-a-with-an-href-attribute-that-points-to-the-url-for-the-cancelorder-view-cant-find-my-error 
@age.route('/scrt_delete_for_good2/<int:selected_scrt_id>', methods=['GET', 'POST'])
#Here author is user_id
...
@age.route('/scrt_delete', methods=['GET', 'POST'])
#Here author is user_id
def scrt_delete():
...
#delete from index scrts list
#from https://teamtreehouse.com/community/add-a-a-with-an-href-attribute-that-points-to-the-url-for-the-cancelorder-view-cant-find-my-error 
@age.route('/scrt_delete2/<int:selected_scrt_id>', methods=['GET', 'POST'])
#Here author is user_id
