...
general_txt = Table('general_txt', post_meta,
    ...
    Column('table_color', String(length=10)),
...
def upgrade(migrate_engine):
    ...
    post_meta.tables['general_txt'].columns['h_plural_name'].create()
    post_meta.tables['general_txt'].columns['table_color'].create()
    post_meta.tables['general_txt'].columns['title_color'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['general_txt'].columns['h_plural_name'].drop()
    post_meta.tables['general_txt'].columns['table_color'].drop()
    post_meta.tables['general_txt'].columns['title_color'].drop()
