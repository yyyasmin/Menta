...
general_txt = Table('general_txt', pre_meta,
    ...
    Column('type_txt', VARCHAR(length=50)),
)
...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['general_txt'].columns['type_txt'].drop()
    post_meta.tables['general_txt'].columns['gt_type'].create()
    post_meta.tables['general_txt'].columns['gt_type_txt'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['general_txt'].columns['type_txt'].create()
    post_meta.tables['general_txt'].columns['gt_type'].drop()
    post_meta.tables['general_txt'].columns['gt_type_txt'].drop()
